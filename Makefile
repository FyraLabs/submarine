...
$(INITFS_X64):
	mkdir -p build
	GBB_PATH=u-root ./u-root/u-root -o $(WORKDIR)/$(INITFS_X64) -uinitcmd="elvish -c 'sleep 3; boot'" core ./cmds/boot/boot
...
$(INITFS_A64):
	...
	GBB_PATH=u-root GOOS=linux GOARCH=arm64 ./u-root/u-root -o $(WORKDIR)/$(INITFS_A64) -uinitcmd="elvish -c 'sleep 3; boot'" core ./cmds/boot/boot
